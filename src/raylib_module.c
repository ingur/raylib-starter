...
static bool Mesh__init__(int argc, py_Ref argv) {
    ...
    if(argc == 1) {
        ...
        self->boneCount = py_toint(py_arg(10));
        if(!py_checkint(py_arg(11))) return false;
        self->boneIndices = (unsigned char *)py_toint(py_arg(11));
        if(!py_checkint(py_arg(12))) return false;
        self->boneWeights = (float *)py_toint(py_arg(12));
        if(!py_checkint(py_arg(13))) return false;
        self->animVertices = (float *)py_toint(py_arg(13));
        if(!py_checkint(py_arg(14))) return false;
        self->animNormals = (float *)py_toint(py_arg(14));
        if(!py_checkint(py_arg(15))) return false;
        self->vaoId = py_toint(py_arg(15));
        if(!py_checkint(py_arg(16))) return false;
        self->vboId = (unsigned int *)py_toint(py_arg(16));
    } else {
        return TypeError("expected 1 or 17 arguments");
    }
    py_newnone(py_retval());
...
static bool Mesh__get_boneIndices(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    Mesh* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->boneIndices);
    return true;
}
static bool Mesh__set_boneIndices(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    Mesh* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
    self->boneIndices = (unsigned char *)py_toint(py_arg(1));
    py_newnone(py_retval());
    return true;
}
...
static py_Type register__Mesh(py_GlobalRef mod) {
    ...
    py_bindproperty(type, "boneIndices", Mesh__get_boneIndices, Mesh__set_boneIndices);
...
static bool ModelSkeleton__new__(int argc, py_Ref argv) {
    py_Type cls = py_totype(argv);
    py_newobject(py_retval(), cls, 0, sizeof(ModelSkeleton));
    return true;
}
static bool ModelSkeleton__init__(int argc, py_Ref argv) {
    ModelSkeleton* self = py_touserdata(argv);
    if(argc == 1) {
        memset(self, 0, sizeof(ModelSkeleton));
    } else if(argc == 1 + 3) {
        if(!py_checkint(py_arg(1))) return false;
        self->boneCount = py_toint(py_arg(1));
        if(!py_checkint(py_arg(2))) return false;
        self->bones = (BoneInfo *)py_toint(py_arg(2));
        if(!py_checkint(py_arg(3))) return false;
        self->bindPose = (Transform *)py_toint(py_arg(3));
    } else {
        return TypeError("expected 1 or 4 arguments");
    }
    py_newnone(py_retval());
...
static bool ModelSkeleton__get_boneCount(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    ModelSkeleton* self = py_touserdata(argv);
    py_newint(py_retval(), self->boneCount);
    return true;
}
static bool ModelSkeleton__set_boneCount(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    ModelSkeleton* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
    self->boneCount = py_toint(py_arg(1));
...
static bool ModelSkeleton__get_bones(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    ModelSkeleton* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->bones);
    return true;
}
static bool ModelSkeleton__set_bones(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    ModelSkeleton* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
...
static bool ModelSkeleton__get_bindPose(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    ModelSkeleton* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->bindPose);
    return true;
}
static bool ModelSkeleton__set_bindPose(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    ModelSkeleton* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
...
static py_Type register__ModelSkeleton(py_GlobalRef mod) {
    py_Type type = py_newtype("ModelSkeleton", tp_stdc_Memory, mod, NULL);
    py_newint(py_emplacedict(py_tpobject(type), py_name("size")), sizeof(ModelSkeleton));
    py_bindmethod(type, "__new__", ModelSkeleton__new__);
    py_bindmethod(type, "__init__", ModelSkeleton__init__);
    py_bindproperty(type, "boneCount", ModelSkeleton__get_boneCount, ModelSkeleton__set_boneCount);
    py_bindproperty(type, "bones", ModelSkeleton__get_bones, ModelSkeleton__set_bones);
    py_bindproperty(type, "bindPose", ModelSkeleton__get_bindPose, ModelSkeleton__set_bindPose);
    return type;
}
static py_Type tp_user_ModelSkeleton;
...
static bool Model__init__(int argc, py_Ref argv) {
    ...
    if(argc == 1) {
        ...
        do {
            if(!py_checktype(py_arg(7), tp_user_ModelSkeleton)) return false;
            self->skeleton = *(ModelSkeleton*)py_touserdata(py_arg(7));
        } while(0);
        if(!py_checkint(py_arg(8))) return false;
        self->currentPose = (Transform *)py_toint(py_arg(8));
        if(!py_checkint(py_arg(9))) return false;
        self->boneMatrices = (Matrix *)py_toint(py_arg(9));
    } else {
...
static bool Model__get_skeleton(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    Model* self = py_touserdata(argv);
    do {
        ModelSkeleton* ud = py_newobject(py_retval(), tp_user_ModelSkeleton, 0, sizeof(ModelSkeleton));
        *ud = self->skeleton;
    } while(0);
    return true;
}
static bool Model__set_skeleton(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    Model* self = py_touserdata(argv);
    do {
        if(!py_checktype(py_arg(1), tp_user_ModelSkeleton)) return false;
        self->skeleton = *(ModelSkeleton*)py_touserdata(py_arg(1));
    } while(0);
    py_newnone(py_retval());
    return true;
}
static bool Model__get_currentPose(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    Model* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->currentPose);
    return true;
}
static bool Model__set_currentPose(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    Model* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
    self->currentPose = (Transform *)py_toint(py_arg(1));
    py_newnone(py_retval());
    return true;
}
static bool Model__get_boneMatrices(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    Model* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->boneMatrices);
    return true;
}
static bool Model__set_boneMatrices(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    Model* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
...
static py_Type register__Model(py_GlobalRef mod) {
    ...
    py_bindproperty(type, "skeleton", Model__get_skeleton, Model__set_skeleton);
    py_bindproperty(type, "currentPose", Model__get_currentPose, Model__set_currentPose);
    py_bindproperty(type, "boneMatrices", Model__get_boneMatrices, Model__set_boneMatrices);
    return type;
}
...
static bool ModelAnimation__init__(int argc, py_Ref argv) {
    ...
    if(argc == 1) {
        ...
        // _0 name is read-only
        if(!py_checkint(py_arg(2))) return false;
        self->boneCount = py_toint(py_arg(2));
        if(!py_checkint(py_arg(3))) return false;
        self->keyframeCount = py_toint(py_arg(3));
        if(!py_checkint(py_arg(4))) return false;
        self->keyframePoses = (Transform * *)py_toint(py_arg(4));
    } else {
        return TypeError("expected 1 or 5 arguments");
    }
    py_newnone(py_retval());
...
static bool ModelAnimation__get_keyframeCount(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    ModelAnimation* self = py_touserdata(argv);
    py_newint(py_retval(), self->keyframeCount);
    return true;
}
static bool ModelAnimation__set_keyframeCount(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    ModelAnimation* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
    self->keyframeCount = py_toint(py_arg(1));
    py_newnone(py_retval());
    return true;
}
static bool ModelAnimation__get_keyframePoses(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    ModelAnimation* self = py_touserdata(argv);
    py_newint(py_retval(), (py_i64)self->keyframePoses);
    return true;
}
static bool ModelAnimation__set_keyframePoses(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    ModelAnimation* self = py_touserdata(argv);
    if(!py_checkint(py_arg(1))) return false;
    self->keyframePoses = (Transform * *)py_toint(py_arg(1));
    py_newnone(py_retval());
    return true;
}
static py_Type register__ModelAnimation(py_GlobalRef mod) {
    ...
    py_bindproperty(type, "keyframeCount", ModelAnimation__get_keyframeCount, ModelAnimation__set_keyframeCount);
    py_bindproperty(type, "keyframePoses", ModelAnimation__get_keyframePoses, ModelAnimation__set_keyframePoses);
    return type;
}
...
static bool FilePathList__init__(int argc, py_Ref argv) {
    ...
    if(argc == 1) {
        ...
        if(!py_checkint(py_arg(2))) return false;
        self->paths = (char **)py_toint(py_arg(2));
    } else {
        return TypeError("expected 1 or 3 arguments");
    }
    py_newnone(py_retval());
...
static bool cfunc__FileRename(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(1))) return false;
    _1 = py_tostr(py_arg(1));
    int res = FileRename(_0, _1);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__FileRemove(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    int res = FileRemove(_0);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__FileCopy(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(1))) return false;
    _1 = py_tostr(py_arg(1));
    int res = FileCopy(_0, _1);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__FileMove(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(1))) return false;
    _1 = py_tostr(py_arg(1));
    int res = FileMove(_0, _1);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__FileTextReplace(int argc, py_Ref argv) {
    PY_CHECK_ARGC(3);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(2))) return false;
    _2 = py_tostr(py_arg(2));
    int res = FileTextReplace(_0, _1, _2);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__FileTextFindIndex(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(1))) return false;
    _1 = py_tostr(py_arg(1));
    int res = FileTextFindIndex(_0, _1);
    py_newint(py_retval(), res);
    return true;
}
...
static bool cfunc__GetDirectoryFileCount(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    unsigned int res = GetDirectoryFileCount(_0);
    py_newint(py_retval(), res);
    return true;
}
static bool cfunc__GetDirectoryFileCountEx(int argc, py_Ref argv) {
    PY_CHECK_ARGC(3);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkbool(py_arg(2))) return false;
    _2 = py_tobool(py_arg(2));
    unsigned int res = GetDirectoryFileCountEx(_0, _1, _2);
    py_newint(py_retval(), res);
    return true;
}
...
static bool cfunc__ComputeSHA256(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    unsigned char * _0;
    if(!py_checkint(py_arg(0))) return false;
    _0 = (unsigned char *)py_toint(py_arg(0));
    ...
    if(!py_checkint(py_arg(1))) return false;
    _1 = py_toint(py_arg(1));
    unsigned int * res = ComputeSHA256(_0, _1);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
...
static bool cfunc__GetKeyName(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    int _0;
    if(!py_checkint(py_arg(0))) return false;
    _0 = py_toint(py_arg(0));
    const char * res = GetKeyName(_0);
    py_newstr(py_retval(), res);
    return true;
}
...
static bool cfunc__DrawLineDashed(int argc, py_Ref argv) {
    PY_CHECK_ARGC(5);
    Vector2 _0;
    do {
        if(!py_checktype(py_arg(0), tp_vec2)) return false;
...
static bool cfunc__DrawCircleGradient(int argc, py_Ref argv) {
    ...
    DrawCircleGradient(_0, _1, _2, _3);
    py_newnone(py_retval());
    return true;
}
...
static bool cfunc__DrawEllipseV(int argc, py_Ref argv) {
    PY_CHECK_ARGC(4);
    Vector2 _0;
    do {
        if(!py_checktype(py_arg(0), tp_vec2)) return false;
...
static bool cfunc__DrawEllipseLinesV(int argc, py_Ref argv) {
    PY_CHECK_ARGC(4);
    Vector2 _0;
    do {
        if(!py_checktype(py_arg(0), tp_vec2)) return false;
...
static bool cfunc__LoadFontEx(int argc, py_Ref argv) {
    ...
    const int * _2;
    if(!py_checkint(py_arg(2))) return false;
    _2 = (const int *)py_toint(py_arg(2));
    int _3;
    if(!py_checkint(py_arg(3))) return false;
    _3 = py_toint(py_arg(3));
...
static bool cfunc__LoadFontFromMemory(int argc, py_Ref argv) {
    ...
    const int * _4;
    if(!py_checkint(py_arg(4))) return false;
    _4 = (const int *)py_toint(py_arg(4));
    int _5;
    if(!py_checkint(py_arg(5))) return false;
    _5 = py_toint(py_arg(5));
...
static bool cfunc__LoadFontData(int argc, py_Ref argv) {
    ...
    const int * _3;
    if(!py_checkint(py_arg(3))) return false;
    _3 = (const int *)py_toint(py_arg(3));
    int _4;
    if(!py_checkint(py_arg(4))) return false;
    _4 = py_toint(py_arg(4));
    int _5;
    ...
    int * _6;
    if(!py_checkint(py_arg(6))) return false;
    _6 = (int *)py_toint(py_arg(6));
    GlyphInfo * res = LoadFontData(_0, _1, _2, _3, _4, _5, _6);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
...
static bool cfunc__MeasureTextCodepoints(int argc, py_Ref argv) {
    PY_CHECK_ARGC(5);
    Font _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Font)) return false;
    ...
    float _4;
    if(!py_castfloat32(py_arg(4), &_4)) return false;
    Vector2 res = MeasureTextCodepoints(_0, _1, _2, _3, _4);
    py_newvec2(py_retval(), *(c11_vec2*)(&res));
    return true;
}
...
static bool cfunc__LoadTextLines(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkint(py_arg(1))) return false;
    _1 = (int *)py_toint(py_arg(1));
    char ** res = LoadTextLines(_0, _1);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
static bool cfunc__UnloadTextLines(int argc, py_Ref argv) {
    PY_CHECK_ARGC(2);
    char ** _0;
    if(!py_checkint(py_arg(0))) return false;
    _0 = (char **)py_toint(py_arg(0));
...
static bool cfunc__TextRemoveSpaces(int argc, py_Ref argv) {
    PY_CHECK_ARGC(1);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    const char * res = TextRemoveSpaces(_0);
    py_newstr(py_retval(), res);
    return true;
}
static bool cfunc__GetTextBetween(int argc, py_Ref argv) {
    PY_CHECK_ARGC(3);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(2))) return false;
    _2 = py_tostr(py_arg(2));
    char * res = GetTextBetween(_0, _1, _2);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
...
static bool cfunc__TextReplaceAlloc(int argc, py_Ref argv) {
    PY_CHECK_ARGC(3);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(2))) return false;
    _2 = py_tostr(py_arg(2));
    char * res = TextReplaceAlloc(_0, _1, _2);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
static bool cfunc__TextReplaceBetween(int argc, py_Ref argv) {
    PY_CHECK_ARGC(4);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    char * res = TextReplaceBetween(_0, _1, _2, _3);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
static bool cfunc__TextReplaceBetweenAlloc(int argc, py_Ref argv) {
    PY_CHECK_ARGC(4);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkstr(py_arg(3))) return false;
    _3 = py_tostr(py_arg(3));
    char * res = TextReplaceBetweenAlloc(_0, _1, _2, _3);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
...
static bool cfunc__TextInsertAlloc(int argc, py_Ref argv) {
    PY_CHECK_ARGC(3);
    const char * _0;
    if(!py_checkstr(py_arg(0))) return false;
    _0 = py_tostr(py_arg(0));
    ...
    if(!py_checkint(py_arg(2))) return false;
    _2 = py_toint(py_arg(2));
    char * res = TextInsertAlloc(_0, _1, _2);
    py_newint(py_retval(), (py_i64)res);
    return true;
}
...
static bool cfunc__UpdateModelAnimationEx(int argc, py_Ref argv) {
    PY_CHECK_ARGC(6);
    Model _0;
    do {
        if(!py_checktype(py_arg(0), tp_user_Model)) return false;
    ...
    ModelAnimation _3;
    do {
        if(!py_checktype(py_arg(3), tp_user_ModelAnimation)) return false;
        _3 = *(ModelAnimation*)py_touserdata(py_arg(3));
    } while(0);
    float _4;
    if(!py_castfloat32(py_arg(4), &_4)) return false;
    float _5;
    if(!py_castfloat32(py_arg(5), &_5)) return false;
    UpdateModelAnimationEx(_0, _1, _2, _3, _4, _5);
    py_newnone(py_retval());
    return true;
}
...
void py__add_module_raylib() {
    ...
    tp_user_ModelSkeleton = register__ModelSkeleton(mod);
    ...
    py_bindfunc(mod, "FileCopy", &cfunc__FileCopy);
    py_bindfunc(mod, "FileMove", &cfunc__FileMove);
    py_bindfunc(mod, "FileTextReplace", &cfunc__FileTextReplace);
    py_bindfunc(mod, "FileTextFindIndex", &cfunc__FileTextFindIndex);
    ...
    py_bindfunc(mod, "GetDirectoryFileCount", &cfunc__GetDirectoryFileCount);
    py_bindfunc(mod, "GetDirectoryFileCountEx", &cfunc__GetDirectoryFileCountEx);
    ...
    py_bindfunc(mod, "ComputeSHA256", &cfunc__ComputeSHA256);
    ...
    py_bindfunc(mod, "GetKeyName", &cfunc__GetKeyName);
    ...
    py_bindfunc(mod, "DrawLineDashed", &cfunc__DrawLineDashed);
    ...
    py_bindfunc(mod, "DrawEllipseV", &cfunc__DrawEllipseV);
    py_bindfunc(mod, "DrawEllipseLines", &cfunc__DrawEllipseLines);
    py_bindfunc(mod, "DrawEllipseLinesV", &cfunc__DrawEllipseLinesV);
    ...
    py_bindfunc(mod, "MeasureTextCodepoints", &cfunc__MeasureTextCodepoints);
    ...
    py_bindfunc(mod, "LoadTextLines", &cfunc__LoadTextLines);
    py_bindfunc(mod, "UnloadTextLines", &cfunc__UnloadTextLines);
    ...
    py_bindfunc(mod, "TextRemoveSpaces", &cfunc__TextRemoveSpaces);
    py_bindfunc(mod, "GetTextBetween", &cfunc__GetTextBetween);
    py_bindfunc(mod, "TextReplace", &cfunc__TextReplace);
    py_bindfunc(mod, "TextReplaceAlloc", &cfunc__TextReplaceAlloc);
    py_bindfunc(mod, "TextReplaceBetween", &cfunc__TextReplaceBetween);
    py_bindfunc(mod, "TextReplaceBetweenAlloc", &cfunc__TextReplaceBetweenAlloc);
    py_bindfunc(mod, "TextInsert", &cfunc__TextInsert);
    py_bindfunc(mod, "TextInsertAlloc", &cfunc__TextInsertAlloc);
    ...
    py_bindfunc(mod, "UpdateModelAnimationEx", &cfunc__UpdateModelAnimationEx);
    ...
    ADD_ENUM(SHADER_LOC_MATRIX_BONETRANSFORMS);
    ADD_ENUM(SHADER_LOC_VERTEX_INSTANCETRANSFORM);
