...
class Camera3D:
    ...
    fovy: float # Camera field-of-view aperture in Y (degrees) in perspective, used as near plane height in world units in orthographic (float)
...
class Camera2D:
    offset: vec2 # Camera offset (screen space offset from window origin) (Vector2)
    target: vec2 # Camera target (world space target point that is mapped to screen space offset) (Vector2)
    rotation: float # Camera rotation in degrees (pivots around target) (float)
    zoom: float # Camera zoom (scaling around target), must not be set to 0, set to 1.0f for no scale (float)
...
class Mesh:
    ...
    boneCount: int # Number of bones (MAX: 256 bones) (int)
    boneIndices: intptr # Vertex bone indices, up to 4 bones influence by vertex (skinning) (shader-location = 6) (unsigned char *)
    ...
    def __init__(self): ...
    @overload
    def __init__(self, vertexCount: int, triangleCount: int, vertices: intptr, texcoords: intptr, texcoords2: intptr, normals: intptr, tangents: intptr, colors: intptr, indices: intptr, boneCount: int, boneIndices: intptr, boneWeights: intptr, animVertices: intptr, animNormals: intptr, vaoId: int, vboId: intptr): ...
...
class ModelSkeleton:
    ...
    bindPose: intptr # Bones base transformation (Transform[]) (Transform *)
    
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, boneCount: int, bones: intptr, bindPose: intptr): ...
...
class Model:
    ...
    skeleton: ModelSkeleton # Skeleton for animation (ModelSkeleton)
    currentPose: intptr # Current animation pose (Transform[]) (Transform *)
    boneMatrices: intptr # Bones animated transformation matrices (Matrix *)
    
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, transform: Matrix, meshCount: int, materialCount: int, meshes: intptr, materials: intptr, meshMaterial: intptr, skeleton: ModelSkeleton, currentPose: intptr, boneMatrices: intptr): ...
    
class ModelAnimation:
    name: intptr # Animation name (char[32])
    boneCount: int # Number of bones (per pose) (int)
    keyframeCount: int # Number of animation key frames (int)
    keyframePoses: intptr # Animation sequence keyframe poses [keyframe][pose] (Transform * *)
    
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, name: intptr, boneCount: int, keyframeCount: int, keyframePoses: intptr): ...
...
class FilePathList:
    ...
    def __init__(self): ...
    @overload
    def __init__(self, count: int, paths: intptr): ...
...
def FileRename(fileName: str, fileRename: str, /) -> int:
    """Wraps `int FileRename(const char * fileName, const char * fileRename)`

    Rename file (if exists)"""

def FileRemove(fileName: str, /) -> int:
    """Wraps `int FileRemove(const char * fileName)`

    Remove file (if exists)"""

def FileCopy(srcPath: str, dstPath: str, /) -> int:
    """Wraps `int FileCopy(const char * srcPath, const char * dstPath)`

    Copy file from one path to another, dstPath created if it doesn't exist"""

def FileMove(srcPath: str, dstPath: str, /) -> int:
    """Wraps `int FileMove(const char * srcPath, const char * dstPath)`

    Move file from one directory to another, dstPath created if it doesn't exist"""

def FileTextReplace(fileName: str, search: str, replacement: str, /) -> int:
    """Wraps `int FileTextReplace(const char * fileName, const char * search, const char * replacement)`

    Replace text in an existing file"""

def FileTextFindIndex(fileName: str, search: str, /) -> int:
    """Wraps `int FileTextFindIndex(const char * fileName, const char * search)`
...
def ChangeDirectory(dirPath: str, /) -> bool:
    """Wraps `bool ChangeDirectory(const char * dirPath)`
...
def GetDirectoryFileCount(dirPath: str, /) -> int:
    """Wraps `unsigned int GetDirectoryFileCount(const char * dirPath)`

    Get the file count in a directory"""

def GetDirectoryFileCountEx(basePath: str, filter: str, scanSubdirs: bool, /) -> int:
    """Wraps `unsigned int GetDirectoryFileCountEx(const char * basePath, const char * filter, bool scanSubdirs)`
...
def DecodeDataBase64(text: str, outputSize: intptr, /) -> intptr:
    """Wraps `unsigned char * DecodeDataBase64(const char * text, int * outputSize)`
...
def ComputeSHA256(data: intptr, dataSize: int, /) -> intptr:
    """Wraps `unsigned int * ComputeSHA256(unsigned char * data, int dataSize)`
...
def GetKeyName(key: int, /) -> str:
    """Wraps `const char * GetKeyName(int key)`
...
def DrawLineDashed(startPos: vec2, endPos: vec2, dashSize: int, spaceSize: int, color: color32, /) -> None:
    """Wraps `void DrawLineDashed(Vector2 startPos, Vector2 endPos, int dashSize, int spaceSize, Color color)`
...
def DrawCircleGradient(center: vec2, radius: float, inner: color32, outer: color32, /) -> None:
    """Wraps `void DrawCircleGradient(Vector2 center, float radius, Color inner, Color outer)`
...
def DrawEllipseV(center: vec2, radiusH: float, radiusV: float, color: color32, /) -> None:
    """Wraps `void DrawEllipseV(Vector2 center, float radiusH, float radiusV, Color color)`
...
def DrawEllipseLinesV(center: vec2, radiusH: float, radiusV: float, color: color32, /) -> None:
    """Wraps `void DrawEllipseLinesV(Vector2 center, float radiusH, float radiusV, Color color)`
...
def DrawRectangleGradientEx(rec: Rectangle, topLeft: color32, bottomLeft: color32, bottomRight: color32, topRight: color32, /) -> None:
    """Wraps `void DrawRectangleGradientEx(Rectangle rec, Color topLeft, Color bottomLeft, Color bottomRight, Color topRight)`
...
def ImageDrawTriangleFan(dst: intptr, points: intptr, pointCount: int, color: color32, /) -> None:
    """Wraps `void ImageDrawTriangleFan(Image * dst, const Vector2 * points, int pointCount, Color color)`

    Draw a triangle fan defined by points within an image (first vertex is the center)"""

def ImageDrawTriangleStrip(dst: intptr, points: intptr, pointCount: int, color: color32, /) -> None:
    """Wraps `void ImageDrawTriangleStrip(Image * dst, const Vector2 * points, int pointCount, Color color)`
...
def LoadFontEx(fileName: str, fontSize: int, codepoints: intptr, codepointCount: int, /) -> Font:
    """Wraps `Font LoadFontEx(const char * fileName, int fontSize, const int * codepoints, int codepointCount)`
...
def LoadFontFromMemory(fileType: str, fileData: intptr, dataSize: int, fontSize: int, codepoints: intptr, codepointCount: int, /) -> Font:
    """Wraps `Font LoadFontFromMemory(const char * fileType, const unsigned char * fileData, int dataSize, int fontSize, const int * codepoints, int codepointCount)`
...
def LoadFontData(fileData: intptr, dataSize: int, fontSize: int, codepoints: intptr, codepointCount: int, type: int, glyphCount: intptr, /) -> intptr:
    """Wraps `GlyphInfo * LoadFontData(const unsigned char * fileData, int dataSize, int fontSize, const int * codepoints, int codepointCount, int type, int * glyphCount)`
...
def MeasureTextCodepoints(font: Font, codepoints: intptr, length: int, fontSize: float, spacing: float, /) -> vec2:
    """Wraps `Vector2 MeasureTextCodepoints(Font font, const int * codepoints, int length, float fontSize, float spacing)`
...
def LoadTextLines(text: str, count: intptr, /) -> intptr:
    """Wraps `char ** LoadTextLines(const char * text, int * count)`

    Load text as separate lines ('\n')"""

def UnloadTextLines(text: intptr, lineCount: int, /) -> None:
    """Wraps `void UnloadTextLines(char ** text, int lineCount)`
...
def TextRemoveSpaces(text: str, /) -> str:
    """Wraps `const char * TextRemoveSpaces(const char * text)`

    Remove text spaces, concat words"""

def GetTextBetween(text: str, begin: str, end: str, /) -> intptr:
    """Wraps `char * GetTextBetween(const char * text, const char * begin, const char * end)`

    Get text between two strings"""

def TextReplace(text: str, search: str, replacement: str, /) -> intptr:
    """Wraps `char * TextReplace(const char * text, const char * search, const char * replacement)`

    Replace text string with new string"""

def TextReplaceAlloc(text: str, search: str, replacement: str, /) -> intptr:
    """Wraps `char * TextReplaceAlloc(const char * text, const char * search, const char * replacement)`

    Replace text string with new string, memory must be MemFree()"""

def TextReplaceBetween(text: str, begin: str, end: str, replacement: str, /) -> intptr:
    """Wraps `char * TextReplaceBetween(const char * text, const char * begin, const char * end, const char * replacement)`

    Replace text between two specific strings"""

def TextReplaceBetweenAlloc(text: str, begin: str, end: str, replacement: str, /) -> intptr:
    """Wraps `char * TextReplaceBetweenAlloc(const char * text, const char * begin, const char * end, const char * replacement)`
...
def TextInsertAlloc(text: str, insert: str, position: int, /) -> intptr:
    """Wraps `char * TextInsertAlloc(const char * text, const char * insert, int position)`

    Insert text in a defined byte position, memory must be MemFree()"""

def TextJoin(textList: intptr, count: int, delimiter: str, /) -> intptr:
    """Wraps `char * TextJoin(char ** textList, int count, const char * delimiter)`

    Join text strings with delimiter"""

def TextSplit(text: str, delimiter: int, count: intptr, /) -> intptr:
    """Wraps `char ** TextSplit(const char * text, char delimiter, int * count)`
...
def TextFindIndex(text: str, search: str, /) -> int:
    """Wraps `int TextFindIndex(const char * text, const char * search)`

    Find first text occurrence within a string, -1 if not found"""

def TextToUpper(text: str, /) -> intptr:
    """Wraps `char * TextToUpper(const char * text)`

    Get upper case version of provided string"""

def TextToLower(text: str, /) -> intptr:
    """Wraps `char * TextToLower(const char * text)`

    Get lower case version of provided string"""

def TextToPascal(text: str, /) -> intptr:
    """Wraps `char * TextToPascal(const char * text)`

    Get Pascal case notation version of provided string"""

def TextToSnake(text: str, /) -> intptr:
    """Wraps `char * TextToSnake(const char * text)`

    Get Snake case notation version of provided string"""

def TextToCamel(text: str, /) -> intptr:
    """Wraps `char * TextToCamel(const char * text)`
...
def UpdateModelAnimation(model: Model, anim: ModelAnimation, frame: float, /) -> None:
    """Wraps `void UpdateModelAnimation(Model model, ModelAnimation anim, float frame)`

    Update model animation pose (vertex buffers and bone matrices)"""

def UpdateModelAnimationEx(model: Model, animA: ModelAnimation, frameA: float, animB: ModelAnimation, frameB: float, blend: float, /) -> None:
    """Wraps `void UpdateModelAnimationEx(Model model, ModelAnimation animA, float frameA, ModelAnimation animB, float frameB, float blend)`
...
SHADER_LOC_MATRIX_BONETRANSFORMS: int = 28
SHADER_LOC_VERTEX_INSTANCETRANSFORM: int = 29
...
SHADER_UNIFORM_UINT: int = 8
SHADER_UNIFORM_UIVEC2: int = 9
SHADER_UNIFORM_UIVEC3: int = 10
SHADER_UNIFORM_UIVEC4: int = 11
SHADER_UNIFORM_SAMPLER2D: int = 12
