...
> [!NOTE]
> Previous versions live on the [`pocketpy`](https://github.com/ingur/raylib-starter/tree/pocketpy) and [`luajit`](https://github.com/ingur/raylib-starter/tree/luajit) branches.
